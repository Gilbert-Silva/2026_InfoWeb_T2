...
class Compromisso:
    def __init__(self, id, evento, local, data_hora):
        self.set_id(id)
    ...
    def __str__(self):
        return f"{self.__id} - {self.__evento} - {self.__local} -\
...
class UI:
    ...
    def inserir(cls):
        ...
        x = Compromisso(id, evento, local, data_hora)
